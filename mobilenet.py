...
Original file is located at
    https://colab.research.google.com/drive/1RkXXAs5li0T9mRdf2tIsENF8RQ11q8o7
"""
...
def samples_from_dirs(data_dirs):
    images_lst = []
    target_lst = []

    for data_dir in data_dirs:
        images_data_dir = join(data_dir, 'images')
        target_data_dir = join(data_dir, 'masks')
        file_names = [f for f in os.listdir(images_data_dir)]
        file_names.sort()
        for name in file_names:

            images_lst.append(name)
            target_lst.append(name)
